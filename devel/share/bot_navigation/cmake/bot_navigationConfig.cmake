...
if("TRUE" STREQUAL "TRUE")
  set(bot_navigation_SOURCE_PREFIX /home/neleps/SLAM/src/bot_navigation)
  set(bot_navigation_DEVEL_PREFIX /home/neleps/SLAM/devel)
  ...
  set(bot_navigation_INSTALL_PREFIX /home/neleps/SLAM/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'neleps <neleps@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/neleps/SLAM/src/bot_navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/neleps/SLAM/devel/lib;/opt/ros/melodic/lib)
